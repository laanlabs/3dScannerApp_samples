...
class LineMesh(object):
    def __init__(self, points, lines=None, colors=[0, 1, 0], radius=0.15, use_arrows=False):
    ...
    def create_line_mesh(self):
        ...
        for i in range(line_segments_unit.shape[0]):
            ...
            if self.use_arrows:
                cylinder_segment = o3d.geometry.TriangleMesh.create_arrow(
                    cylinder_radius=self.radius, cone_radius=self.radius*5, cylinder_height=line_length, 
                    cone_height=self.radius*5, resolution=5, cylinder_split=1, cone_split=1)
            else:
